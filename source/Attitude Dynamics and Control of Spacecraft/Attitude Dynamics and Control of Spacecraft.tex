...
%版本号
\newcommand{\version}{V1.04.010$\,\,$(内测版)}
...
%引理类
\newcommand{\lemma}[1][]{\vspace{1em}\s \refstepcounter{lemma} \hspace*{0.15em} \mybox[inference]{{\color{inference}\thelemma\hspace{1em}}\\ \hspace*{1.5em}#1}\vspace{0.5em}   \par}
