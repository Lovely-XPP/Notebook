...
\fancyfoot[RO,LE]{\footnotesize\CJKfamily{heilight}{工程热力学与传热学}}
\fancyfoot[RE,LO]{\footnotesize\CJKfamily{heilight}Engineering Thermodynamics and Heat Transfer}
...
\newcommand{\dya}[1][]{{\color{dy}#1}}
\newcommand{\dybox}[1][]{\vspace*{0.7em} \noindent \tcbox[colframe =DarkGreen, colback =ForestGreen,boxrule=0.5mm,size=small,on line]{\color{dybox}{\textbf{#1}}} \hspace*{1em} }
\newcommand{\eq}[1][]{\colorbox{eq}{$\displaystyle #1$}}
\newcommand{\ds}[1][]{\colorbox{文字底色}{#1}}
\newcommand{\m}{\text{m}}
\newcommand{\sumk}{\sum_{i = 1}^k} 
\newcommand{\dsumk}{ \displaystyle \sum_{i = 1}^k}
\def\degree{{}^{\circ}}
\newcommand{\rgap}{\vspace*{1em}}
\newcommand{\f}{\text{f}}
\newcommand{\w}{\text{w}}
\newcommand{\ch}{\text{ch}}
\newcommand{\sh}{\text{sh}}
...
\newenvironment{itemizea}{\begin{enumerate}[\hspace*{1.5em}]}{\end{enumerate}}
\tcolorboxenvironment{itemizea}
{blanker, before skip = 6pt, after skip = 6pt,colback=yellow!10!white,
	borderline west = {1mm}{0pt}{white}}
