...
\fancyfoot[RO,LE]{\footnotesize\CJKfamily{heilight}{导弹飞行力学}}
\fancyfoot[RE,LO]{\footnotesize\CJKfamily{heilight}Missle Flight Dynamics}
...
\newcommand{\vj}{\bm{j}}
\newcommand{\vk}{\bm{k}}
\newcommand{\vrho}{\bm{\bm{\rho}}}
\newcommand{\vr}{\bm{\bm{r}}}
\newcommand{\vp}{\bm{\bm{p}}}
\newcommand{\vP}{\bm{\bm{P}}}
\newcommand{\vV}{\bm{V}}
\newcommand{\vH}{\bm{H}}
...
%文章标题
\title{
	\Huge{\textbf{导弹飞行力学}\thanks{本笔记已经开源，可以免费下载，github地址：https://github.com/Lovely-XPP/Notebook\\ \hspace*{5.24cm} gitee分流地址：https://gitee.com/sysu\_xpp/Notebook}}
	\vspace*{16em}
}
\author{
	{  \large {易鹏}}\\
