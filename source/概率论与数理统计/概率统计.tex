...
\fancyfoot[RO,LE]{\footnotesize\CJKfamily{heilight}{概率论与数理统计}}
\fancyfoot[RE,LO]{\footnotesize\CJKfamily{heilight} Probability \& Statistics}
...
\renewcommand{\textbf}[1]{{\CJKfamily{heiti}#1}\jg \par }%
