...
\begin{figure}[h]
	\subfigure[三点]{
		\begin{minipage}[b]{0.33\linewidth}
			\centering
			\includegraphics[width=0.9\linewidth]{picture/C-2/2.1/pm1.pdf}
			%\caption{fig1}
			\label{pm1}
		\end{minipage}%
	}%
	\subfigure[定点加垂线]{
		\begin{minipage}[b]{0.33\linewidth}
			\centering
			\includegraphics[width=0.9\linewidth]{picture/C-2/2.1/pm2.pdf}
			%\caption{fig2}
			\label{pm2}
		\end{minipage}%
	}%
	\subfigure[外点加直线]{
		\begin{minipage}[b]{0.33\linewidth}
			\centering
			\includegraphics[width=0.95\linewidth]{picture/C-2/2.1/pm3.pdf}
			%\caption{fig2}
			\label{pm3}
		\end{minipage}%
	}%
	...
	\subfigure[两相交直线]{
		\begin{minipage}[b]{0.5\linewidth}
			\centering
			\includegraphics[width=0.9\linewidth]{picture/C-2/2.1/pm4.pdf}
			%\caption{fig2}
			\label{pm4}
		\end{minipage}%
	}%
	\subfigure[两平行直线]{
		\begin{minipage}[b]{0.5\linewidth}
			\centering
			\includegraphics[width=0.9\linewidth]{picture/C-2/2.1/pm5.pdf}
			%\caption{fig2}
			\label{pm5}
		\end{minipage}%
	}%
...
\begin{enumerate}[\large1.]
	...
	\begin{figure}[h]
		...
		\subfigure[点法式方程]{
			\begin{minipage}[b]{0.5\linewidth}
				\centering
				\includegraphics[width=0.9\linewidth]{picture/C-2/2.1/DFS.pdf}
				%\caption{fig1}
				\label{DFS}
			\end{minipage}%
		}%
		\subfigure[向量式法式方程]{
			\begin{minipage}[b]{0.5\linewidth}
				\centering 
				\includegraphics[width=0.9\linewidth]{picture/C-2/2.1/XLFS.pdf}
				%\caption{fig2}
				\label{XLFS}
			\end{minipage}%
		}%
...
\begin{enumerate}[\large1.]
	...
	\begin{figure}[h]
		...
		\subfigure[一般式方程]{
			\begin{minipage}[b]{0.5\linewidth}
				\centering
				\includegraphics[width=0.9\linewidth]{picture/C-2/2.3/ZXYBFC.pdf}
				\label{ZSYBFC}
			\end{minipage}
		}
...
\begin{figure}[h]
	...
	\subfigure[直线和平面的夹角]{
		\begin{minipage}[b]{0.4\linewidth}
			\centering
			\includegraphics[width=0.9\linewidth]{picture/C-2/2.6/JJ3.pdf}
			\label{直线和平面的夹角}
		\end{minipage}
	}
						\caption{线性图形的夹角}
