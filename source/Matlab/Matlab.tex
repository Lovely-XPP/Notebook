...
%文章标题
\title{
	\textbf{\Huge{Matlab 与 科学计算}\thanks{本笔记已经开源，可以免费下载，github地址：https://github.com/Lovely-XPP/Notebook\\ \hspace*{5.24cm} gitee分流地址：https://gitee.com/sysu\_xpp/Notebook}}\\
	\vspace*{25em}
}
\author{
	{  \large {易鹏}}\\
...
\fancyfoot[RO,LE]{\footnotesize\CJKfamily{heilight}{Matlab 与 科学计算}}
\fancyfoot[RE,LO]{\footnotesize\CJKfamily{heilight}Matlab and Science Calculation}
...
\newcommand{\solve}{\vspace*{1em} \noindent  \hspace*{0.2em}  \tcbox[colframe =black, colback =black!10!white,boxrule=0.5mm,size=small,on line]{\color{black}{{ 解}}}\hspace{1.5em}}
...
\newcommand{\warn}[1][]{
	\vspace*{0.5em}
	\begin{tcolorbox}[colframe=red!75!black, colback=yellow!10!white,title=注意,fonttitle = \bfseries]
		#1
\end{tcolorbox}}
