...
\newcommand{\ttheorem}[1][]{\vspace*{-1em} \s \refstepcounter{theorem}\label{#1} \mybox[dl]{\color{dl}\thetheorem\hspace{1em}#1} \par }
...
%文章标题
\title{
	\Huge{\textbf{数学物理方法}}\thanks{本笔记已经开源，可以免费下载，github地址：https://github.com/Lovely-XPP/Notebook\\ \hspace*{5.24cm} gitee分流地址：https://gitee.com/sysu\_xpp/Notebook}\\
    \vspace*{15em}
}
\author{
	{  \large {易鹏}}\\
	{  \large 中山大学}\\
	 指导老师\hspace*{1em} 胡战超\vspace*{0.5em}\\
	内部版本号：V7.38.070$\,\,$(公测版)\\
}
...
\fancyfoot[RO,LE]{\footnotesize\CJKfamily{heilight}{数学物理方法}}
\fancyfoot[RE,LO]{\footnotesize\CJKfamily{heilight}Essential Mathematical Methods for Physicists}
...
\newcommand{\peref}[1][]{第\pageref{#1}页的公式\eqref{#1}}
\newcommand{\ptref}[1][]{第\pageref{#1}页的表\ref{#1}}
\newcommand{\pfref}[1][]{第\pageref{#1}页的图\ref{#1}}
\def\degree{{}^{\circ}}
...
%--------------------------------------------------------图框定义---------------------------------------------------------%
%证明和解
\newcommand{\proof}{\vspace*{1em} \noindent  \hspace*{0.2em}  \tcbox[colframe =black, colback =black!10!white,boxrule=0.5mm,size=small,on line]{\color{black}{{ 证\hspace*{0.2em}}}}\hspace{1.5em}}
\newcommand{\solve}{\vspace*{1em} \noindent  \hspace*{0.2em}  \tcbox[colframe =black, colback =black!10!white,boxrule=0.5mm,size=small,on line]{\color{black}{{ 解}}\hspace*{0.2em}}\hspace{1.5em}}
\newcommand{\solveother}{\vspace*{1em} \noindent  \hspace*{0.2em}  \tcbox[colframe =black, colback =black!10!white,boxrule=0.5mm,size=small,on line]{\color{black}{{ 另解}}\hspace*{0.2em}}\hspace{1.5em}}
...
%例
\newcommand{\examples}{\vspace*{1em}\noindent  \refstepcounter{examples} \tcbox[colframe =ex, colback =ex!10!white,boxrule=0.5mm,size=small,on line]{\color{ex}{\theexamples} \hspace*{0.2em}}\hspace{1.5em}}
