...
\begin{center}
	\begin{tikzpicture}[node distance=1.2cm]
		...
		\node (C2) [minimum height=0cm,draw, below of=C,node distance=1.2cm,inner sep=8pt,xshift =8.45cm] {可去间断点};
		\node (D) [minimum height=0cm,draw, below of=C,node distance=2.4cm,inner sep=8pt] {\quad   函数在$x$处连续 \quad \quad  };
