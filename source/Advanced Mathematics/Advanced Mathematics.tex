...
%文章标题
\title{
	\Huge{高等数学$\,$\uppercase\expandafter{\romannumeral1}$\,$ 总结\thanks{本笔记已经开源，可以免费下载，github地址：https://github.com/Lovely-XPP/Notebook\\ \hspace*{5.24cm} gitee分流地址：https://gitee.com/sysu\_xpp/Notebook}}\\
	\quad\\
	\quad\\
	\quad\\
	\quad\\
